...
import { LuFolderOpen, LuHardDrive, LuPlus, LuTrash2, LuTriangleAlert } from 'react-icons/lu';
import {
  createVolume,
  deleteVolume,
  listVolumes,
...
export function VolumesCard() {
  ...
  return (
    <>
      <Card>
        <Card.Header>
          ...
          <Card.Description>
            ...
            attached agent. Attach from an agent&apos;s settings (or when creating one);
            attach/detach applies on the agent&apos;s next rebuild.
          </Card.Description>
        </Card.Header>
                        ...
                        <Tooltip>
                          ...
                          <Tooltip.Content showArrow className="max-w-[280px]">
                            ...
                            <p className="px-1 py-1.5 text-xs">
                              ...
                              yet). The gateway re-mounts volumes at boot; if this persists, restart
                              the dashboard stack.
                            </p>
                          </Tooltip.Content>
                        </Tooltip>
                      ...
                      {confirmDelete === v.name ? (
                        ...
                        <div className="flex items-center gap-1">
                          <Button
                            ...
                            isDisabled={!v.mounted || busy !== null}
                            onPress={() => setBrowsing(v.name)}
                          >
      ...
      <FileExplorer
        apiBase={browsing ? volumeFilesBase(browsing) : ''}
        title={browsing ? `Shared volume — ${browsing}` : ''}
        copyPathRoot={browsing ? `/home/agent/Shared/${browsing}` : ''}
